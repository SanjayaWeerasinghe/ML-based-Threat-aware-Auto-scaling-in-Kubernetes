"""
Isolation Forest Model Training - V3
...
print("=" * 80)
print("ISOLATION FOREST V3 - BCCC-cPacket Cloud DDoS 2024")
print("=" * 80)
...
print("\n" + "=" * 80)
print("✅ ISOLATION FOREST V3 TRAINING COMPLETE!")
print("=" * 80)
print(f"\nModel Summary:")
...
print(f"\nV2 Comparison:")
print(f"  V2: 49.06% accuracy, 5.63% FPR")
