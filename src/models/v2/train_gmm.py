"""
Gaussian Mixture Model (GMM) Training - V2
CIC-IDS2018 Dataset
"""
...
print("=" * 80)
print("GAUSSIAN MIXTURE MODEL (GMM) V2 - CIC-IDS2018 Dataset")
print("=" * 80)
...
print(f"   Components: 1 (single Gaussian for normal traffic)")
...
# Get scores and calculate threshold
...
# Save metrics
metrics = {
    'Model': 'Gaussian Mixture Model - V2',
    'Dataset': 'CIC-IDS2018',
...
print("\n" + "=" * 80)
print("✅ GMM V2 TRAINING COMPLETE!")
print("=" * 80)
print(f"\nModel Summary:")
...
print(f"\nV1 Comparison:")
print(f"  V1: 47.74% accuracy, 10.17% FPR")
