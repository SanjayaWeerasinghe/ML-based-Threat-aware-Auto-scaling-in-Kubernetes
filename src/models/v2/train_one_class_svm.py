"""
One-Class SVM Model Training - V2
CIC-IDS2018 Dataset
Note: SVM is slower with large datasets, using smaller sample
"""
...
print("=" * 80)
print("ONE-CLASS SVM V2 - CIC-IDS2018 Dataset")
print("=" * 80)
...
print(f"   Kernel: RBF")
print(f"   nu: 0.1 (expected outlier fraction)")
...
print("\n" + "=" * 80)
print("✅ ONE-CLASS SVM V2 TRAINING COMPLETE!")
print("=" * 80)
print(f"\nModel Summary:")
...
print(f"\nV1 Comparison:")
print(f"  V1: 54.97% accuracy, 9.56% FPR")
