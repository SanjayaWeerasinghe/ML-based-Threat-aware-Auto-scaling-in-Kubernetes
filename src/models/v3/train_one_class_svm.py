"""
One-Class SVM Model Training - V3
...
print("=" * 80)
print("ONE-CLASS SVM V3 - BCCC-cPacket Cloud DDoS 2024")
print("=" * 80)
...
print("\n5. Training One-Class SVM model...")
print(f"   Algorithm: One-Class SVM")
print(f"   Kernel: {KERNEL}")
print(f"   Nu: {NU} (expected outlier fraction)")
print(f"   Gamma: {GAMMA}")
print(f"   Training samples: {len(X_train):,}")
print(f"   ⏰ This may take 30-60 minutes with {len(X_train):,} samples...")
...
model_path = os.path.join(MODELS_DIR, "one_class_svm_model.pkl")
scaler_path = os.path.join(MODELS_DIR, "one_class_svm_scaler.pkl")
...
metrics_path = os.path.join(RESULTS_DIR, "one_class_svm_metrics.csv")
metrics_df.to_csv(metrics_path, index=False)

print(f"   ✓ Metrics saved to: {metrics_path}")

print("\n" + "=" * 80)
print("✅ ONE-CLASS SVM V3 TRAINING COMPLETE!")
print("=" * 80)
print(f"\nModel Summary:")
print(f"├── Training: {len(X_train):,} benign samples, {training_time:.2f}s ({training_time/60:.1f}m)")
...
print(f"\nV2 Comparison:")
print(f"  V2: 54.97% accuracy, 9.56% FPR")
