"""
Isolation Forest Model Evaluation with Balanced Test Set
...
print("=" * 80)
print("ISOLATION FOREST EVALUATION - BALANCED TEST SET")
print("=" * 80)
...
print("\n" + "=" * 80)
print("ISOLATION FOREST - BALANCED TEST SET RESULTS")
print("=" * 80)
...
metrics_path = os.path.join(RESULTS_DIR, "isolation_forest_metrics_balanced.csv")
...
print(f"\nModel Comparison:")
print(f"  KNN (Balanced):               66.35% accuracy, 20.69% FPR")
print(f"  Isolation Forest (Balanced):  {accuracy*100:.2f}% accuracy, {fpr*100:.2f}% FPR")
