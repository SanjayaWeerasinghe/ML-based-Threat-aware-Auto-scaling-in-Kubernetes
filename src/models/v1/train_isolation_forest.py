...
First anomaly detection model for HTTP traffic classification
"""
...
# Convert labels to binary (Normal=1, Anomalous=-1 for Isolation Forest)
# Note: Isolation Forest expects inliers=1, outliers=-1
...
model = IsolationForest(
    contamination='auto',  # Auto-detect anomaly proportion
...
# Convert predictions to match label format for evaluation
...
metrics_path = os.path.join("../../results", "isolation_forest_metrics.csv")
